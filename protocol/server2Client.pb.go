...
func (Server2ClientKey) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*Server2Client) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func init() { proto.RegisterFile("server2Client.proto", fileDescriptor7) }
